...
<body>
    ...
    <td>
        ...
        <center> <h1> <strong> Facture </strong> </h1> </center>
        <br> <br> <br>
        <?php
        ...
        foreach ($result as $row) {
            ...
            echo '<br>'; echo $row['Addrs']; echo '<br>';
            echo '<strong>'; echo $row['CodPost']; echo ' '; echo $row['Ville']; echo '</strong>'; echo '<br>'; echo '<br>';
            echo '<div class="row mx-md-n5">';
            echo '<div class="col px-md-5"></div>';
            echo ' <div class="col px-md-5">';
            echo $row['NomSport']; echo '<br>'; echo "à l'attention de "; echo $row['Nom']; 
            echo '</div>';          
        }
    ?>
        ...
        <table class="table table-borderless">
        <tr> 
        <td> Date </td> <td> Code Client </td> <td> N° Facture </td> <td> Échéance </td>
        </tr>
        <tr>
        <br> <br> <br>
        <?php
        ...
        $result = $sth->fetchAll(PDO::FETCH_ASSOC); 
        foreach ($result as $row) {
            echo '<td>' ;  echo $row['DateDeb'] ; echo '</td>';
            echo '<td>' ;  echo $row['NumLigue'] ; echo '</td>';
            echo '<td>' ;  echo $row['idFacture'] ; echo '</td>';
            echo '<td>' ;  echo $row['DateEcheance'] ; echo '</td>';
        }
    ?>
    </tr>
    </table>
    ...
    <table class="table  ">
        <tr> 
        <th scope="col"> Référence </th> <th scope="col"> Désignation </th>
        <th scope="col"> Quantité </th> <th scope="col"> PUHT </th> <th scope="col"> Montant HT </th>
        </tr>
        <?php
        $i = 0;
        $t = 0;
        ...
        foreach ($result as $row) {
            ...
            echo '<td>' ;  echo $row['Qte'] ; echo '</td>';
            echo '<td>' ;  echo $row['Prix'] ; echo '</td>';
            $total[$i] = $row['Prix'] * $row['Qte'];
            echo '<td>' ;  echo $total[$i] ; echo '€'; echo '</td>';
            echo '</tr>';
            $i++;
            $t++;
    ...
    TVA non applicable
    <br> <br> <br> <br>
    Siret 31740105700029 <br> Tél <strong> 03.83.18.87.02 </strong> <br> Fax 03.83.18.87.03
    </h1>
    </div>
    </td>
    </tr>
